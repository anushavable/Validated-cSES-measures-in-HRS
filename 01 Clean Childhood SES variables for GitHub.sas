/*************************************************************************************************** 	
	...
	Description: 	This code pulls in variables from various HRS core data sets and the tracker data set, 
					then cleans them in preparation for exploratory factor analysis 
...
/* 	ok! quite a few peole change their responses over time.  I wrote in the manuscript that I'd use the first reported response option, so 
	...
	I didn't do this for famses because we used both the expanded response options for famses in 1996, and the reduced response 
	options for famses recorded later in the factor analysis in an effort to keep as much information as possible */   
...
/* Code for Appendix 1 - from dataset called "merged" */ 
